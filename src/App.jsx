...
import FaceRecogniton from "/src/Components/FaceRecogniton/FaceRecogniton.jsx";
...
class App extends Component {
  ...
  onButtonSubmit = () => {
    console.log("I Got Cliked , Yayyyyy!");

    const PAT = "85bce1997f8541d4b023f3fd8ff02f00";

    const USER_ID = "aktolgali4796";
    const APP_ID = "face-detction";
